...
# inputs:
#
# 1. case - a string value. should be the name of one of the .pdf files downloaded from the 
#              supremecourt.gov site and saved to the 'data' directory in the project.
